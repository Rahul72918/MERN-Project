        ...
        <div className="relative m-4" ref={dropdownRef}>
            ...
            >
                <div className="flex items-center gap-3">
                    {/* 🔧 FIX: Show fallback avatar if no image */}
                    {currentWorkspace?.image_url ? (
                        ...
                        <div className="w-8 h-8 rounded bg-blue-500 flex items-center justify-center text-white font-semibold shadow">
                ...
                <div className="absolute z-50 w-64 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded shadow-lg top-full left-0">
                    <div className="p-2">
                        ...
                        {userMemberships.data.map(({ organization }) => (
                            ...
                            >
                                {/* 🔧 Also safe-guard organization image */}
                                {organization.imageUrl ? (
                                    ...
                                    <div className="w-6 h-6 rounded bg-purple-500 flex items-center justify-center text-white text-xs font-semibold">
